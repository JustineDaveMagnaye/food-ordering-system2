...
using Food_Ordering_System.views.modal;
            ...
            foreach(var item in items)
{
                ...
                {
                    Size = new Size(flp_Receipt.Width - 10, itemPanelHeight),
                    BackColor = color2,
                    BorderRadius = 8,
                ...
                var btnDecrease = new Guna.UI2.WinForms.Guna2CircleButton
                {
                    Size = new Size(30, 30),
                    MaximumSize = new Size(30, 30),
                    FillColor = Color.FromArgb(255, 114, 102),
                    ForeColor = Color.Black,
                    Font = new Font("Segoe UI", 7, FontStyle.Bold),
                    BorderColor = Color.FromArgb(255, 20, 0),
                    BorderThickness = 3,
                    Text = "-",
                    Dock = DockStyle.Right
                };
                btnDecrease.Click += (sender, e) =>
                {
                    ...
                    else
                    {
                        ...
                        foreach (Guna2Button card in flp_Products.Controls)
                        {
                            Label nameLabels = card.Controls.OfType<Label>().FirstOrDefault(lbl => lbl.Text == item.FoodName);
                            if (nameLabels != null)
                            {
                                card.Checked = false;
                                Label lblPrices = card.Controls.OfType<Label>().FirstOrDefault(l => l.Text.Contains("Price:"));
                                PictureBox pbImages = card.Controls.OfType<PictureBox>().FirstOrDefault();
                                if (lblPrices != null) lblPrices.BackColor = Color.White;
                                if (nameLabels != null) nameLabels.BackColor = Color.White;
                                if (pbImages != null) pbImages.BackColor = Color.White;
                                break;
                            }
                        }
                    }
            ...
            {
                Size = new Size(flp_Receipt.Width - 10, summaryPanelHeight),
                BackColor = Color.WhiteSmoke,
                BorderRadius = 8,
                Padding = new Padding(10),
            ...
            {
                Size = new Size(flp_Receipt.Width - 10, buttonPanelHeight),
                BackColor = Color.WhiteSmoke,
                BorderRadius = 8,
                Padding = new Padding(10),
                Margin = new Padding(5, 10, 5, 5),
            ...
            btnGCash.Click += (sender, e) =>
            {
                if (items.Count > 0)
                {
                    ...
                    if (form.ShowDialog(this) == DialogResult.OK)
                    {
                        ...
                        DinningOption dinningOption = new DinningOption { ReceiveDataId = ReceiveDataId, IsAdmin = IsAdmin };
                        dinningOption.Show();
            ...
            btnCash.Click += (sender, e) =>
            {
                if (items.Count > 0)
                {
                    CashAmount cashAmount = new CashAmount{totalAmount = (int)cart.GetTotalPrice()};
                    if (cashAmount.ShowDialog(this) == DialogResult.OK)
                    {
                        ...
                        receipt.CashAmount = cashAmount.Amount;
                        this.Close();
                        receipt.ReceiveDataId = ReceiveDataId;
                        receipt.ShowDialog();
                    }
        ...
        private void btn_maindish_Click_1(object sender, EventArgs e)
        {
            selectedCategory = "Main Dish";
            LoadProducts(category: selectedCategory);
        }

        private void btn_appetizer_Click_1(object sender, EventArgs e)
        {
            selectedCategory = "Appetizer";
            LoadProducts(category: selectedCategory);
        }

        private void btn_dessert_Click_1(object sender, EventArgs e)
        {
            selectedCategory = "Dessert";
            LoadProducts(category: selectedCategory);
        }

        private void btn_drinks_Click_1(object sender, EventArgs e)
        {
        ...
        private void btnDineIn_Click_1(object sender, EventArgs e)
        {
            IsDineIn = true;
        }
