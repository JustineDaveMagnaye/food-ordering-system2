...
namespace Food_Ordering_System
{
    public partial class DinningOption : Form
    {
        ...
        {
            MainOptions menu = new MainOptions { IsDineIn = true, ReceiveDataId = ReceiveDataId, IsAdmin = IsAdmin };
            this.Visible = false;
            menu.Show();
        }
        ...
        {
            MainOptions menu = new MainOptions { IsDineIn = false, ReceiveDataId = ReceiveDataId, IsAdmin = IsAdmin };
            this.Visible = false;
            menu.Show();
        }
        ...
        private void DinningOption_Load(object sender, EventArgs e)
        {
            if (IsAdmin)
            {
        ...
        {
            AdminPage nextPage = new AdminPage{ReceiveDataId = ReceiveDataId};
            this.Close();
            nextPage.Show();
        }
    }
